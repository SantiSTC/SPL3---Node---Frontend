...
app.post("/agregarJugueteBD", verificar_jwt, upload.single("foto"), (request:any, response:any) => {
    ...
    let path : string = file.destination + juguete.marca + "." + extension;
...
app.delete('/toys', (request:any, response:any)=>{
    ...
    request.getConnection((err:any, conn:any)=>{
        ...
        conn.query("select path_foto from juguetes where id = ?", [juguete.id_juguete], (err:any, result:any)=>{
            ...
            if(hay_registro)
            {
                request.getConnection((err:any, conn:any)=>{
                    ...
                    conn.query("delete from juguetes where id = ?", [juguete.id_juguete], (err:any, rows:any)=>{
...
app.post('/toys', upload.single("foto"), (request:any, response:any)=>{
    ...
    request.getConnection((err:any, conn:any)=>{
        ...
        conn.query("update juguetes set ? where id = ?", [juguete_modif, juguete.id_juguete], (err:any, rows:any)=>{
